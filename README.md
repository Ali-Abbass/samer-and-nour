...
| **Opening video** | `ASSETS.introVideo` → replace `public/videos/intro.mp4`. It loads paused on its first frame behind a "tap to open" control; the tap plays it with sound and primes the music. When it ends, it fades into the invitation. |
