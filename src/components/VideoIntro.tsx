...
export function VideoIntro({ content, children }: VideoIntroProps) {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className={`intro-loading pointer-events-none absolute inset-0 z-10 flex items-end justify-center pb-[18dvh] transition-opacity duration-300 ${
      ...
      <button
        ...
        disabled={!waiting}
        aria-hidden={!waiting}
        className={`intro-tap-target absolute inset-0 z-10 flex cursor-pointer items-end justify-center pb-[5dvh] transition-opacity duration-500 ${
